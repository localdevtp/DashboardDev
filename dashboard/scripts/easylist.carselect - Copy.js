var GlassURL = "http://glasses.rest.mongodbv1.dev.easylist.com.au/EasyListGlass/";
...
function getGlassCode(){
	return $('input:radio[name=listing-variant]:checked').attr('data-attribute').trim();
        ...
        $(document).ready(function () {
            ...
            $.getJSON(GlassURL + 'AllMakes', function (data) {
        ...
        function MakeChange(element) {
			...
			*/
            ...
            $.getJSON(GlassURL + 'info?type=Models&make=' + Make, function (data) {
                var items = [];
        ...
        function ModelChange(element) {
            ...
            $.getJSON(GlassURL + 'info?type=Years&make=' + Make + '&model=' + Model, function (data) {
...
*/
            ...
            $.getJSON(GlassURL + 'info?type=Styles&make=' + Make + '&model=' + Model + '&year=' + Year, function (data) {
        ...
        function StyleChange(element) {
            ...
            $.getJSON(GlassURL + 'info?type=Transmissions&make=' + Make + '&model=' + Model + '&year=' + Year + '&style=' + Style, function (data) {
        ...
        function TransmissionChange(element) {
            ...
            $.getJSON(GlassURL + 'MatchingVehicle?make=' + Make + '&model=' + Model + '&year=' + Year + '&style=' + Style + '&Transmission=' + Transmission, function (data) {
        ...
        function MachingVehicleChange(element) {
            ...
            $.getJSON(GlassURL + 'MatchingVehicleFeatures?GlassCode=' + GlassCode
            ,
            function (data) {
                var sfItems = [];
                var ofItems = [];
