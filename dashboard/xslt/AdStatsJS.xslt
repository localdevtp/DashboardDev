...
function randNum(){
	...
	{	
		...
		var plot = $.plot($("#ad-stats"),
			   [ { data: visits, label: "Active Ads"},
				 { data: pageviews, label: "Ad Views"},
				 { data: visitors, label: "Leads" }, 
				 { data: newVisitors, label: "Closes"} ], {
				   series: {
					   lines: { show: true,
								lineWidth: 2
							 },
		...
		$("#ad-stats").bind("plothover", function (event, pos, item) {
