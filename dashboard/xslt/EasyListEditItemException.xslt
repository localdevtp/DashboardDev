...
exclude-result-prefixes="msxml easylist scripts umbraco.library Exslt.ExsltCommon Exslt.ExsltDatesAndTimes Exslt.ExsltMath Exslt.ExsltRegularExpressions Exslt.ExsltStrings Exslt.ExsltSets ">
  ...
  <textarea>
                ...
                <div class="tab-content widget-content">
                    ...
                    <div id="specs" class="tab-pane">
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <input class="text" type="text" disabled="disabled" maxlength="100" name="listing-make" value="{$data/VehicleListing/Make}" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="text" type="text" disabled="disabled" maxlength="100" name="listing-model" value="{$data/VehicleListing/Model}" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="text year" type="text" disabled="disabled" maxlength="4" name="listing-year" value="{$data/VehicleListing/Year}" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="text" type="text" maxlength="50" name="listing-transmission-description">
                      ...
                      <xsl:attribute name="checked">checked</xsl:attribute>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="text" type="text" maxlength="50" name="listing-engine-size-description">
                                    <xsl:attribute name="value">
                                        <xsl:choose>
                                            <xsl:when test="$IsPostBack = 'true'">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="text" type="text" maxlength="50" name="listing-engine-cylinders">
                                    <xsl:attribute name="value">
                                        <xsl:choose>
                                            <xsl:when test="$IsPostBack = 'true'">
                ...
                <div class="tab-content widget-content">
                    ...
                    <div id="specs" class="tab-pane">
                        <div class="form-left">
							...
							<a class="btn btn-danger push-bottom" id="FixListingSpec" href="#">
								<i class="icon-camera">&nbsp;</i> Fix Listing Spec
							</a>
						
                            <div class="control-group ">
                                <label class="control-label">Make</label>
                                <div class="controls">
                                    <input class="text" type="text" disabled="disabled" maxlength="100" name="listing-make" id="listing-auto-make" value="{$data/VehicleListing/Make}" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label">Model</label>
                                <div class="controls">
                                    <input class="text" type="text" disabled="disabled" maxlength="100" name="listing-model" id="listing-auto-model" value="{$data/VehicleListing/Model}" />
                                </div>
                            </div>
                            ...
                            <xsl:if test="$data/VehicleListing/Series !=''">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="text" type="text" disabled="disabled" maxlength="100" name="listing-series" id="listing-auto-series" value="{$data/VehicleListing/Series}" />
                                    </div>
                                </div>
                            </xsl:if>
                            ...
                            <div class="control-group">
                                <label class="control-label">Year</label>
                                <div class="controls">
                                    <input class="text year" type="text" disabled="disabled" maxlength="4" name="listing-year" id="listing-auto-year" value="{$data/VehicleListing/Year}" />
                                </div>
                            </div>
                      ...
                      <xsl:attribute name="checked">checked</xsl:attribute>
							...
							<xsl:if test="$data/VehicleListing/Variant !=''">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="text" type="text" disabled="disabled" maxlength="100" name="listing-variant" id="listing-auto-variant" value="{$data/VehicleListing/Variant}" />
                                    </div>
                                </div>
                            </xsl:if>
    ...
    <xsl:template name="standardfields">
		...
		<!-- Feed In Exception -->
		<xsl:for-each select="$data/ListingsDataFeedException/DataFeedException">
			<xsl:choose>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="text allow-lowercase" id="listing-status" type="text" readonly = "readonly" name="listing-status" value="{$data/ListingStatusDesc}">
        ...
        <div class="control-group">
            <label class="control-label">Stock Number/SKU</label>
            <div class="controls">
                <input class="text allow-lowercase" type="text" maxlength="50" name="listing-stock-number">
                    <xsl:attribute name="data-validate">{required: false, minlength: 1, maxlength: 50, messages: {required: 'Please enter the stock number'}}</xsl:attribute>
                    <xsl:attribute name="value">
                        <xsl:choose>
                            <xsl:when test="$IsPostBack = 'true'">
