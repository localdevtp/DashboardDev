<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CountryRegionPostcodeBilling.ascx.cs"
Inherits="EasyList.Web.CustomControl.CountryRegionPostcodeBilling" %>
    ...
    <asp:Label ID="LabelCountry" runat="server" Text="Country" 
      ...
      <div class="controls">
            <asp:DropDownList ID="DropDownListCountry" runat="server" Width="205px" 
              ...
              class="drop-down add-billing-country">
            </asp:DropDownList>
       </div>
</div>
...
<div class="control-group clear">
    ...
    <div class="controls">
            <asp:DropDownList ID="DropDownListRegion" runat="server" class="drop-down add-billing-region"
...
<asp:Panel ID="PanelPostCode" runat="server">
    ...
    <asp:Label ID="LabelPostCode" runat="server" Text="Post Code" 
      ...
      <div class="controls">
            <asp:TextBox ID="TextBoxPostCode" runat="server" MaxLength="15"  class="input-xlarge add-billing-postalcode" 
...
<asp:Panel ID="PanelSuburb" runat="server">
    <div class="control-group clear">
        ...
        <div class="controls">
            ...
            <asp:DropDownList ID="ListDistrict" runat="server" class="drop-down add-billing-district-dropdown" 
              DataTextField="District" DataValueField="ID" Visible="False" Width="205px">
            </asp:DropDownList>

            <asp:TextBox ID="TextDistrict" class="input-xlarge add-billing-district" runat="server"></asp:TextBox>
