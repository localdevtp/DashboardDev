        ...
        <form id="fileupload" action="ListingImageHandler.ashx" method="POST" enctype="multipart/form-data">
            ...
            <div class="row fileupload-buttonbar">
                <div class="span7">
					...
					<!--  Remove Upload cancel button, confuse customer when upload start -->
					<!--
...
<!--==================================================================== QUERY UPLOADER ======================================================================-->
	...
	<!--<span class="btn btn-success fileinput-button" style="position: fixed;bottom: 10px;right: 10px;" />
		<i class="icon-checkmark icon-white"></i>
		<div onclick="$('.mfp-close').click(); return false;">Finished adding photos</div>
		<input id="FinishAdd" type="text" onclientclick="$('.mfp-close').click(); return false;" />
	</span>-->
	
	<input id="FinishAdd" class="btn btn-success fileinput-button" style="position: fixed;bottom: 10px;right: 10px;"  type="button" onclick="window.parent.$('.mfp-close').trigger('click');" value="Finished adding photos"/>
</body>
