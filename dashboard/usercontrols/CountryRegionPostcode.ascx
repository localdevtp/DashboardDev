<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CountryRegionPostcode.ascx.cs"
Inherits="EasyList.Web.CustomControl.CountryRegionPostcode" %>
...
<div class="control-group clear">
    ...
    <div class="controls">
            <asp:DropDownList ID="DropDownListRegion" runat="server" class="drop-down add-region"
...
<asp:Panel ID="PanelPostCode" runat="server">
    ...
    <asp:Label ID="LabelPostCode" runat="server" Text="Post Code" 
      ...
      <div class="controls">
            <asp:TextBox ID="TextBoxPostCode" runat="server" MaxLength="15"  class="input-xlarge add-postalcode" 
...
<asp:Panel ID="PanelSuburb" runat="server">
    <div class="control-group clear">
        ...
        <div class="controls">
            ...
            <asp:DropDownList ID="ListDistrict" runat="server" class="drop-down add-district-dropdown" 
              DataTextField="District" DataValueField="ID" Visible="False" Width="205px">
            </asp:DropDownList>

            <asp:TextBox ID="TextDistrict" class="input-xlarge add-district" runat="server"></asp:TextBox>
